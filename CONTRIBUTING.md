...
- [`good first issue`](https://github.com/0end1/codex-in-rust/labels/good%20first%20issue)：小勘误，适合第一次来。
- [`勘误`](https://github.com/0end1/codex-in-rust/labels/%E5%8B%98%E8%AF%AF) label 下的 issue。
